...
This is a addaption to LMIC-node to explain how to stay within TTN-Sanbox regulations.

## Content

-[1 Fair Use Policy](1#-fair-use-policy)
-[2 Air Tim Calculation](2#-air-time-calculation)
...
## 2 Air Tim Calculation

Your devices air time are calculated from the total time you device is transmitting per day. This needs to be less than 30 seconds per day (24 hours).

This calculation is achieved by dividing 24 hours by transmit intervals of your node and multiplying this by the air time of each uplink.

You need to take inconsideration that your SF will possibly change. Basing your calculation on the best possible SF will put you out of the FUP.
